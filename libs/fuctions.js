...
if(!isNumber(user.role)) user.role = 'PRINCIPIANTE'
...
if (user.level <= 2) {
 user.role = 'PRINCIPIANTE'
  ...
  user.role = '🤓 APRENDIZ II'
} else if (user.level <= 15) {
  user.role = '🤓 APRENDIZ'
} else if (user.level <= 17) {
  user.role = 'EXPLORADOR(A) III ⚒️'
} else if (user.level <= 19) {
  user.role = 'EXPLORADOR(A) II ⚒️'
} else if (user.level <= 21) {
  user.role = 'EXPLORADOR(A) ⚒️'
} else if (user.level <= 23) {
  user.role = 'BRONCE III ⛏️ 🦾'
} else if (user.level <= 25) {
  user.role = 'BRONCE II ⛏️ 🦾'
  ...
  user.role = 'SEMIDIOS III ⚜️🔱'
} else if (user.level <= 76) {
  user.role = 'SEMIDIOS II ⚜️🔱'
} else if (user.level <= 79) {
  user.role = 'SEMIDIOS ⚜️🔱'
} else if (user.level <= 84) {
  user.role = '👑 CANDITADO A DIVINO IV 🏁'
} else if (user.level <= 87) {
  user.role = '👑 CANDITADO A DIVINO III 🏁'
} else if (user.level <= 89) {
  user.role = '👑 CANDIDATO A DIVINO II 🏁'
} else if (user.level <= 91) {
  user.role = '👑 CANDITADO A DIVINO 🏁'
} else if (user.level <= 94) {
  user.role = '👑 *∞ DIVINIDAD IV* 💎🏁'    
